...
export const LoanIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="m8 12 5 5" />
    <path d="M11 21H4a2 2 0 0 1-2-2v-2" />
    <path d="m21 13-5-5" />
  </svg>
);
...
export const ReputationIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.5 12.5a2.5 2.5 0 0 1-5 0 2.5 2.5 0 0 1 5 0Z" />
    <path d="M7 10H5a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h2" />
    <path d="M17 10h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2" />
    <path d="M12 22c-2.209 0-4-2.015-4-4.5S9.791 13 12 13s4 2.015 4 4.5-1.791 4.5-4 4.5Z" />
    <path d="m2.9 15.1.7-4.4A2 2 0 0 1 5.5 9h13a2 2 0 0 1 1.9 1.7l.7 4.4" />
  </svg>
);

export const SatisfactionIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RateIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MarketingIcon: React.FC<IconProps> = (props) => (
  <svg {...props} width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10z" /><path d="M12 12v6" /><path d="M15 15H9" />
  </svg>
);
...
export const ArrowUpIcon: React.FC<IconProps> = (props) => (
   <svg {...props} width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
...
export const NextIcon: React.FC<IconProps> = (props) => (
   <svg {...props} width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    <polygon points="5 4 15 12 5 20 5 4"></polygon><line x1="19" y1="5" x2="19" y2="19"></line>
  </svg>
);

export const RestartIcon: React.FC<IconProps> = (props) => (
   <svg {...props} width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21.5 2v6h-6"></path><path d="M2.5 22v-6h6"></path><path d="M2 11.5a10 10 0 0 1 18.8-4.3l-3.3 3.3"></path><path d="M22 12.5a10 10 0 0 1-18.8 4.3l3.3-3.3"></path>
  </svg>
);

export const TrendUpIcon: React.FC<IconProps> = (props) => (
  <svg {...props} width="14" height="14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BalancedIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 6h20" />
    <path d="M12 6V4" />
    <path d="M8 6V4" />
    <path d="M16 6V4" />
    <path d="M5 6l-3 6a2 2 0 0 0 2 3h16a2 2 0 0 0 2-3l-3-6" />
    <path d="M8 15h8" />
    <path d="M12 15V6" />
  </svg>
);
...
export const MoneyBagIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8 3h8a2 2 0 0 1 2 2v2.5a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 6 7.5V5a2 2 0 0 1 2-2z"></path>
        <path d="M12 10v4"></path>
        <path d="M12 18.5A2.5 2.5 0 0 1 9.5 21h-5A2.5 2.5 0 0 1 2 18.5v-13A2.5 2.5 0 0 1 4.5 3H6"></path>
        <path d="M18 3h1.5A2.5 2.5 0 0 1 22 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-5A2.5 2.5 0 0 1 12 18.5V14"></path>
    </svg>
);
...
export const HandshakeIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.5-3.5a1 1 0 1 0-3 3l2 2"></path>
...
export const PaintBrushIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M9 8c-2 3-4 3.5-7 4l8 10c.5-1 .5-2 1-4"></path>
    </svg>
);
...
export const StarFullIcon: React.FC<IconProps> = (props) => (
